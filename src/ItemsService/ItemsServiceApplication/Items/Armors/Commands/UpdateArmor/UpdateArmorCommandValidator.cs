...
namespace ItemsService.ItemsServiceApplication.Items.Armors.Commands.UpdateArmor;

public class UpdateArmorCommandValidator : AbstractValidator<UpdateArmorCommand>
{
    ...
    public UpdateArmorCommandValidator()
    {
