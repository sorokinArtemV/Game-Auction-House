...
namespace GameItems.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240526122650_AddItemTypeProperty")]
    partial class AddItemTypeProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemParameters.ArmorEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemParameters.WeaponEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemTypes.Armor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemTypes.Weapon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemParameters.ArmorEffect", b =>
                {
                    b.HasOne("GameItems.Core.Entities.ItemTypes.Armor", null)
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemParameters.WeaponEffect", b =>
                {
                    b.HasOne("GameItems.Core.Entities.ItemTypes.Weapon", null)
                        .WithMany("SpecialEffects")
            ...
            modelBuilder.Entity("GameItems.Core.Entities.ItemTypes.Armor", b =>
                {
                    b.OwnsOne("GameItems.Core.Entities.ItemParameters.PrimaryStats", "PrimaryStats", b1 =>
                        {
                    ...
                    b.OwnsOne("GameItems.Core.Entities.ItemParameters.SecondaryStats", "SecondaryStats", b1 =>
                        {
                            b1.Property<int>("ArmorId")
                                .HasColumnType("integer");
