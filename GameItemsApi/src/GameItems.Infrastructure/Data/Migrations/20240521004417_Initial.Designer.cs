...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemParameters.ArmorEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemParameters.WeaponEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemTypes.Armor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemTypes.Weapon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemParameters.ArmorEffect", b =>
                {
                    b.HasOne("GameItems.Api.ItemServiceCore.Entities.ItemTypes.Armor", null)
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemParameters.WeaponEffect", b =>
                {
                    b.HasOne("GameItems.Api.ItemServiceCore.Entities.ItemTypes.Weapon", null)
                        .WithMany("SpecialEffects")
            ...
            modelBuilder.Entity("GameItems.Api.ItemServiceCore.Entities.ItemTypes.Armor", b =>
                {
                    b.OwnsOne("GameItems.Api.ItemServiceCore.Entities.ItemParameters.PrimaryStats", "PrimaryStats", b1 =>
                        {
                    ...
                    b.OwnsOne("GameItems.Api.ItemServiceCore.Entities.ItemParameters.SecondaryStats", "SecondaryStats", b1 =>
                        {
                            b1.Property<int>("ArmorId")
                                .HasColumnType("integer");
